...
void StartDefaultTask(void *argument)
{
    char data[] = "Green LED toggle task 1\r\n";
    for(;;)
    {
        if(osMutexAcquire(myMutex01Handle, osWaitForever) == osOK)
        {
            ...
            osMutexRelease(myMutex01Handle);   // ✅ Correct release
        }
        osDelay(1000);
    }
}
...
void StartTask02(void *argument)
{
    char data[] = "Orange LED toggle task 2\r\n";
    for(;;)
    {
        if(osMutexAcquire(myMutex01Handle, osWaitForever) == osOK)
        {
...
void StartTask03(void *argument)
{
    char data[] = "Red LED toggle task 3\r\n";
    for(;;)
    {
        if(osMutexAcquire(myMutex01Handle, osWaitForever) == osOK)
        {
...
void StartTask04(void *argument)
{
    char data[] = "Blue LED toggle task 4\r\n";
    for(;;)
    {
        if(osMutexAcquire(myMutex01Handle, osWaitForever) == osOK)
        {
